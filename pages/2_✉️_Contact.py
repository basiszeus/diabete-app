...
col2.image(Image.open('Walid.png'))

st.header('Walid Soula')

st.info('Big data & AI researcher, EMBA, MBA, MSc | Computer Science | Artificial Intelligence | Marketing Consultant')

icon_size = 20

st_button('medium', 'https://medium.com/@soulawalid', 'Read my Blogs', icon_size)
st_button('twitter', 'https://twitter.com/vagnagun', 'Follow me on Twitter', icon_size)
st_button('linkedin', 'https://www.linkedin.com/in/oualid-soula/', 'Follow me on LinkedIn', icon_size)
st_button('newsletter', 'https://diabetes.org/', 'More infos about diabetes', icon_size)